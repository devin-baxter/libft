...
ft_isdigit.c ft_isprint.c ft_itoa.c ft_lstadd.c ft_lstat.c ft_lstcount.c \
ft_lstdel.c ft_lstdelone.c ft_lstiter.c ft_lstmap.c ft_lstnew.c \
ft_memalloc.c ft_memccpy.c ft_memchr.c ft_memcmp.c \
ft_memcpy.c ft_memdel.c ft_memmove.c ft_memset.c ft_place_value.c \
...
ft_strsub.c ft_strtrim.c ft_tolower.c ft_toupper.c ft_wordcount.c

NAME = libft.a

OBJECTS = ft_atoi.o ft_bzero.o ft_isalnum.o ft_isalpha.o ft_isascii.o \
ft_isdigit.o ft_isprint.o ft_itoa.o ft_lstadd.o ft_lstat.o ft_lstcount.o \
ft_lstdel.o ft_lstdelone.o ft_lstiter.o ft_lstmap.o ft_lstnew.o \
ft_memalloc.o ft_memccpy.o ft_memchr.o ft_memcmp.o \
ft_memcpy.o ft_memdel.o ft_memmove.o ft_memset.o ft_place_value.o \
...
ft_strsub.o ft_strtrim.o ft_tolower.o ft_toupper.o ft_wordcount.o
